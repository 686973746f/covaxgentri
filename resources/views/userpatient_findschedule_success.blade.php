        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <p><strong>Schedule #:</strong> {{$patient->getCurrentSchedData()->id}}</p>
                    <p><strong>Type:</strong> {{$patient->getCurrentSchedData()->sched_type}}</p>
                    <p><strong>Vaccination Center:</strong> {{$patient->getCurrentSchedData()->vaccinationcenter->name}} - {{$patient->getCurrentSchedData()->vaccinationcenter->getAddress()}}</p>
                    <p><strong>Date:</strong> {{date('m/d/Y - l', strtotime($patient->getCurrentSchedData()->for_date))}}</p>
                    <p><strong>Vaccine:</strong> {{$patient->getCurrentSchedData()->vaccinelist->vaccine_name}}</p>
