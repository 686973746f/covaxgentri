...
@section('content')
<form action="{{route('walkin_store')}}" method="POST" autocapitalize="characters" autocomplete="off" enctype="multipart/form-data">
    <div class="container">
        <div class="card">
            <div class="card-header">Create Walk-in Patient</div>
            <div class="card-body">
                @if($errors->any())
